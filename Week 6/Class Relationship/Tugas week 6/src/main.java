...
public class main {
	public static void main(String[] args) {
		...
		guru g1 = new guru(1001,"Severus Snape","Potions","Pria");
		...
		kelas k3 = new kelas(3,"Ravenclaw",Ravenclaw,Ravenclaw1);
		...
		System.out.println("\n===================");
		System.out.println("Total Murid	:"+s1.getTotalMurid());
		System.out.println("Total Guru	:"+s1.getTotalGuru());
		System.out.println("===================\n");
	}
}
